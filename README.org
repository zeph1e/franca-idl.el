...
This elisp script package, *franca-idl.el* is an emacs major mode which highlights Franca IDL keywords and
provides language specific indentation.

* Installation

** el-get

The recipe of this package is not yet in el-get official repository, you should download and copy the recipe
into your local directory which are added to *el-get-recipe-path*.
...
[[http://www.wtfpl.net/txt/copying][WTFPL version 2]]
